...
class SMPLLoader_Customized:
    """Helper for loading frames for SMPL captures."""
    # data: dict
    def __init__(self, data_dir: Path):
        ...
        self.K = self.data['intrinsic']
        poses = self.data['cam_c2w']
    ...
    def get_frame(self, index: int) -> Record3dFrame:
        ...
        # Read RGB.
        rgb = self.data['images'][index]
        # iio.imread(self.rgb_paths[index])
